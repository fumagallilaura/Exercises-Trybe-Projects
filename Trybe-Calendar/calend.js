...
//     let backgroundColorHolidays = getComputedStyle('background-color')
//     // console.log(backgroundColorHolidays)
//     if (backgroundColorHolidays == "red") {
//       daysHolidays[index].style.backgroundColor = "rgb(#eee)"
//     } else {
//       daysHolidays[index].style.backgroundColor = "red"
//     }
//   }
// }
// buttonHoliday.addEventListener('click', clickButton)
//codigo da trybe:
...
// 5 Implemente uma função que receba como parâmetro a string "Sexta-feira" e crie dinamicamente um botão com o nome "Sexta-feira".
...
//  6 Implemente uma função que adicione ao botão "Sexta-feira" um evento de "click" que modifica o texto exibido nos dias que são Sexta-feira.
